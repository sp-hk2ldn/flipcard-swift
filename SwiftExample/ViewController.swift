...
class ViewController: UIViewController, iCarouselDataSource, iCarouselDelegate
{
    ...
    @IBAction func passMeal(sender: UIButton) {
        carousel.scrollByNumberOfItems(1, duration: 1.0)
    }
...
//            newView.backgroundColor = UIColor.whiteColor()
            newView = CustomView(frame: CGRectMake(0, 0, 250, 250))
            newView.backgroundColor = UIColor.clearColor()
            
//            newView = UIImageView(frame:CGRectMake(0, 0, 200, 200))
//            (newView as! UIImageView).image = UIImage(named: "testpage2")
